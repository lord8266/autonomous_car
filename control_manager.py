...
class ControlManager:
    ...
    def __init__(self,simulator,throttle_controls= [0.5,0.8,1],steer_controls=[-0.55,-0.2, 0,0.2, 0.55],brake_controls=[0,0.5]):
    ...
    def generate_states(self):
        ...
        for t in self.throttle_controls:
            if t!=0.5:
                self.controls.append(carla.VehicleControl(throttle = t,steer = 0,brake = self.brake_controls[0],reverse = False))
            else:
